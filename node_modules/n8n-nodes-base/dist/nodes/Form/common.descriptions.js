...
exports.appendAttributionToForm = exports.respondWithOptions = exports.formTriggerPanel = exports.formRespondMode = exports.formFields = exports.formDescription = exports.formTitle = exports.webhookPath = void 0;
    ...
    options: [
        {
            ...
            values: [
                ...
                },
                {
                    ...
                    type: 'string',
                    default: '',
                    description: 'How to format the date in the output data. For a table of tokens and their interpretations, see <a href="https://moment.github.io/luxon/#/formatting?ID=table-of-tokens" target="_blank">here</a>.',
