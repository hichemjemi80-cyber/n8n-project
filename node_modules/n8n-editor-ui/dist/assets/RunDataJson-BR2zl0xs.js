const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-hnNDgPdr.js","assets/index-TQ22MZub.js","assets/index-BGyoJ6bM.css","assets/RunDataJsonActions-zNKrn8z4.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ap as useNDVStore, r as ref, jg as nonExistingJsonPath, jh as useElementSize, p as computed, e4 as executionDataToJson, c as openBlock, h as createElementBlock, e as createBlock, w as withCtx, A as unref, f as createCommentVNode, aS as Suspense, i as createVNode, jc as MappingPill, jd as TextWithHighlights, n as normalizeClass, dO as Draggable, bc as defineAsyncComponent, ei as __vitePreload, s as shorten, jf as getMappedExpression, eL as isString, aF as useExternalHooks, ak as useTelemetry, _ as _export_sfc } from "./index-TQ22MZub.js";
import { V as VueJsonPretty } from "./NodeViewSwitcher-B6pXHQpy.js";
import "./RunDataAi-Dr6ypWYk.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-hnNDgPdr.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
