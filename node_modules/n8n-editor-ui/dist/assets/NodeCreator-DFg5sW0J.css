._searchContainer_dci3d_1 {
  ...
  -webkit-filter: drop-shadow(0px 2px 5px rgba(46, 46, 50, 0.04));
...
._searchContainer_dci3d_1:focus-within {
...
._prefix_dci3d_17._active_dci3d_22 {
...
._text_dci3d_26 input::-webkit-input-placeholder {
  color: var(--color-text-light);
}
._text_dci3d_26 input::placeholder, ._text_dci3d_26 input::-webkit-input-placeholder {
  color: var(--color-text-light);
}
._suffix_dci3d_42 {
  min-width: 20px;
...
._clear_dci3d_48 svg path {
  fill: var(--color-text-light);
}
._clear_dci3d_48:hover svg path {
...
._draggableDataTransfer_124lg_41 {
  width: 1px;
  height: 1px;
}._subCategory_qrigt_1 {
...
._draggableDataTransfer_139su_31 {
  width: 1px;
  height: 1px;
}._view_71tui_1 {
  --action-arrow-color: var(--color-text-light);
  margin-left: var(--spacing-s);
  margin-right: var(--spacing-xs);
}._creatorLink_1hx0p_1 {
  --action-arrow-color: var(--color-text-light);
  margin-left: var(--spacing-s);
  margin-right: var(--spacing-xs);
}._triggerIcon_b4ocq_1 {
...
._category_b4ocq_6:hover::before {
  border-color: var(--color-text-light);
}
._category_b4ocq_6._active_b4ocq_27::before {
...
._arrow_b4ocq_36 {
  ...
  width: 12px;
  color: var(--color-text-light);
}._mouseOverTooltip_1smyb_1 {
  opacity: 0;
  margin-left: var(--spacing-3xs);
  color: var(--color-foreground-xdark);
}
._mouseOverTooltip_1smyb_1:hover {
  color: var(--color-primary);
}
._categorizedItemsRenderer_1smyb_9:hover ._mouseOverTooltip_1smyb_1 {
  opacity: 1;
}
._tooltipPopper_1smyb_13 {
  max-width: 260px;
}
._contentSlot_1smyb_17 {
  padding: 0 var(--spacing-s) var(--spacing-3xs);
  margin-top: var(--spacing-xs);
}
._categorizedItemsRenderer_1smyb_9 {
  padding-bottom: var(--spacing-s);
}._itemSkeleton_1rgyl_1 {
  height: 50px;
}
._iteratorItem_1rgyl_5 {
  margin-left: 1px;
  position: relative;
}
._iteratorItem_1rgyl_5::before {
  content: "";
  position: absolute;
  left: -1px;
  top: 0;
...
._iteratorItem_1rgyl_5:not(._label_1rgyl_17):not(._category_1rgyl_17):hover::before {
  border-color: var(--color-text-light);
}
._iteratorItem_1rgyl_5._active_1rgyl_20:not(._category_1rgyl_17)::before {
  border-color: var(--color-primary);
}
._empty_1rgyl_24 [role="alert"] {
  margin: var(--spacing-xs) var(--spacing-s);
}
._itemsRenderer_1rgyl_28 {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
._itemsRenderer_1rgyl_28 > *::-webkit-scrollbar {
  display: none;
}
._view_1rgyl_37 {
  position: relative;
}
._view_1rgyl_37:last-child {
  margin-top: var(--spacing-s);
  padding-top: var(--spacing-xs);
}
._view_1rgyl_37:last-child:after {
  content: "";
  position: absolute;
  left: var(--spacing-s);
  right: var(--spacing-s);
...
._link_1rgyl_55:last-child {
  margin-bottom: var(--spacing-s);
  padding-bottom: var(--spacing-xs);
}
._link_1rgyl_55:last-child:after {
  content: "";
  position: absolute;
  left: var(--spacing-s);
  right: var(--spacing-s);
...
._borderless_1rgyl_73:last-child {
  margin-top: 0;
  padding-top: 0;
}
._borderless_1rgyl_73:last-child:after {
  content: none;
}._container_25ezu_1 {
  display: -webkit-box;
  display: -ms-flexbox;
...
._resetSearch_25ezu_7 i {
  font-weight: var(--font-weight-bold);
  font-style: normal;
  text-decoration: underline;
}
._actionsEmpty_25ezu_21 {
  padding: var(--spacing-2xs) var(--spacing-xs) var(--spacing-s);
  font-weight: var(--font-weight-regular);
}
._actionsEmpty_25ezu_21 strong {
  font-weight: var(--font-weight-bold);
}
._apiHint_25ezu_29 {
...
._backButton_vhrjt_27 {
  background: transparent;
  border: none;
  cursor: pointer;
  padding: 0 var(--spacing-xs) 0 0;
}
._backButtonIcon_vhrjt_34 {
  color: var(--color-text-light);
  height: 16px;
  padding: 0;
}
...
._renderedItems_vhrjt_45::-webkit-scrollbar {
  display: none;
}
._searchBar_vhrjt_57 {
  -ms-flex-negative: 0;
...
._nodesListPanel_vhrjt_61:before {
...
._header_vhrjt_95._hasBg_vhrjt_101 {
...
._hasBg_vhrjt_101 ._title_vhrjt_106 {
...
._nodeCreatorScrim_180z5_16._active_180z5_28 {
  opacity: 0.7;
}