import { d as defineComponent, p as computed, c as openBlock, h as createElementBlock, q as renderSlot, s as shorten, v as createEventBus, _ as _export_sfc, r as ref, x as debounce, o as onMounted, y as onBeforeUnmount, e as createBlock, w as withCtx, j as createBaseVNode, z as renderList, n as normalizeClass, k as createTextVNode, t as toDisplayString, A as unref, i as createVNode, F as Fragment, B as normalizeStyle, C as nextTick, l as resolveComponent, D as useTagsStore, E as onClickOutside, G as withKeys, H as watch, I as withModifiers, J as useDebounce, K as useUIStore, L as getBannerRowHeight, N as BREAKPOINT_SM, O as BREAKPOINT_XL, P as BREAKPOINT_LG, Q as BREAKPOINT_MD, g as useI18n, V as VIEWS, R as defineStore, S as STORES, T as useWorkflowsStore, u as useUsersStore, U as useRoute, W as TIME, X as PLACEHOLDER_EMPTY_WORKFLOW_ID, Y as useDocumentVisibility, f as createCommentVNode, Z as useRootStore, $ as useCanvasStore, m as useSettingsStore, a0 as useSourceControlStore, a1 as useProjectsStore, a2 as useNpsSurveyStore, b as useRouter, a as useToast, a3 as useDocumentTitle, a4 as useWorkflowHelpers, a5 as useLocalStorage, a6 as MAX_WORKFLOW_NAME_LENGTH, a7 as _sfc_main$f, a8 as EnterpriseEditionFeature, a9 as SaveButton, aa as useCssModule, ab as WORKFLOW_SHARE_MODAL_KEY, ac as nodeViewEventBus, ad as WORKFLOW_MENU_ACTIONS, ae as MODAL_CONFIRM, af as MODAL_CLOSE, ag as WORKFLOW_SETTINGS_MODAL_KEY, ah as SOURCE_CONTROL_PUSH_MODAL_KEY, ai as VALID_WORKFLOW_IMPORT_URL_REGEX, aj as DUPLICATE_MODAL_KEY, ak as useTelemetry, al as useMessage, am as getResourcePermissions, an as hasPermission, ao as MAIN_HEADER_TABS, ap as useNDVStore, aq as useExecutionsStore, ar as onBeforeMount, as as withDirectives, at as vShow, au as STICKY_NODE_TYPE } from "./index-TQ22MZub.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isNodeViewSwitcherEnabled = computed(() => {
      return nodeViewSwitcher.value === "true" || settingsStore.deploymentType === "n8n-internal";
    });
...
const WorkflowDetails = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$1], ["__scopeId", "data-v-dd6d7f07"]]);
