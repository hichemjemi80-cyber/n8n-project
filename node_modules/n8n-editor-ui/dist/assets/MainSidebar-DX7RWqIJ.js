import { d as defineComponent, av as useLoadingService, K as useUIStore, a0 as useSourceControlStore, a as useToast, r as ref, p as computed, c as openBlock, h as createElementBlock, A as unref, n as normalizeClass, j as createBaseVNode, i as createVNode, k as createTextVNode, t as toDisplayString, w as withCtx, e as createBlock, f as createCommentVNode, B as normalizeStyle, g as useI18n, an as hasPermission, ah as SOURCE_CONTROL_PUSH_MODAL_KEY, C as nextTick, aw as sourceControlEventBus, ax as SOURCE_CONTROL_PULL_MODAL_KEY, l as resolveComponent, v as createEventBus, _ as _export_sfc, ay as get, R as defineStore, S as STORES, az as useCloudPlanStore, Z as useRootStore, aA as useStorage, aB as DateTime, ak as useTelemetry, b as useRouter, a1 as useProjectsStore, o as onMounted, F as Fragment, z as renderList, V as VIEWS, m as useSettingsStore, aC as useTemplatesStore, u as useUsersStore, aD as useVersionsStore, T as useWorkflowsStore, J as useDebounce, U as useRoute, y as onBeforeUnmount, aE as createSlots, aF as useExternalHooks, aG as VERSIONS_MODAL_KEY, aH as ABOUT_MODAL_KEY } from "./index-TQ22MZub.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const displayProjects = computed(() => {
      return projectsStore.myProjects.filter((p) => p.type === "team").toSorted((a, b) => {
        if (!a.name || !b.name) {
          return 0;
        }
        if (a.name > b.name) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        displayProjects.value.length || unref(projectsStore).hasPermissionToCreateProjects && unref(projectsStore).isTeamProjectFeatureEnabled ? (openBlock(), createElementBlock("hr", _hoisted_1$1)) : createCommentVNode("", true),
        displayProjects.value.length ? (openBlock(), createBlock(_component_ElMenu, {
          key: 1,
          collapse: props.collapsed,
        ...
        createVNode(_component_N8nTooltip, {
          ...
          default: withCtx(() => [
            unref(projectsStore).hasPermissionToCreateProjects && unref(projectsStore).isTeamProjectFeatureEnabled ? (openBlock(), createBlock(_component_ElMenu, {
              key: 0,
              collapse: props.collapsed,
              class: "pl-xs pr-xs"
            }, {
              ...
              _: 1
            }, 8, ["collapse"])) : createCommentVNode("", true)
          ]),
          _: 1
        }, 8, ["disabled"]),
        displayProjects.value.length || unref(projectsStore).hasPermissionToCreateProjects && unref(projectsStore).isTeamProjectFeatureEnabled ? (openBlock(), createElementBlock("hr", _hoisted_2$1)) : createCommentVNode("", true)
      ], 2);
    };
  }
});
const projects = "_projects_1e7fr_1";
const projectItems = "_projectItems_1e7fr_9";
const upgradeLink = "_upgradeLink_1e7fr_15";
const collapsed = "_collapsed_1e7fr_20";
const style0$1 = {
  projects,
  projectItems,
  upgradeLink,
