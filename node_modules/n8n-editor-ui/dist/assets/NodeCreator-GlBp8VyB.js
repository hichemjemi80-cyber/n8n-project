import { cS as createCompounder, ji as memoize, f4 as i18n, fL as HTTP_REQUEST_NODE_TYPE, jj as getCredentialOnlyNodeType, eP as CUSTOM_API_CALL_KEY, f1 as AI_SUBCATEGORY, d as defineComponent, c5 as reactive, o as onMounted, y as onBeforeUnmount, cq as toRefs, l as resolveComponent, c as openBlock, h as createElementBlock, j as createBaseVNode, i as createVNode, n as normalizeClass, f as createCommentVNode, aF as useExternalHooks, _ as _export_sfc, dY as useNodeType, r as ref, p as computed, e$ as DEFAULT_SUBCATEGORY, jk as CREDENTIAL_ONLY_NODE_PREFIX, d4 as isCommunityPackageName, c9 as resolveDirective, e as createBlock, aE as createSlots, w as withCtx, as as withDirectives, A as unref, d7 as COMMUNITY_NODES_INSTALLATION_DOCS_URL, d3 as _sfc_main$g, B as normalizeStyle, I as withModifiers, at as vShow, g as useI18n, ge as DRAG_EVENT_DATA_KEY, gd as getNewNodePosition, gf as NODE_SIZE, ak as useTelemetry, bP as mergeProps, t as toDisplayString, ds as WEBHOOK_NODE_TYPE, q as renderSlot, T as useWorkflowsStore, H as watch, bQ as normalizeProps, bs as guardReactiveProps, bZ as onUnmounted, F as Fragment, z as renderList, u as useUsersStore, fj as TRIGGER_NODE_CREATOR_VIEW, j1 as OPEN_AI_NODE_TYPE, j0 as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, cQ as withMemo, bt as h, fp as REGULAR_NODE_CREATOR_VIEW, ba as createStaticVNode, k as createTextVNode, jl as REQUEST_NODE_FORM_URL, K as useUIStore, Z as useRootStore, jm as getNodeIconUrl, jn as getNodeIcon, jo as getNodeIconColor, f5 as AI_NODE_CREATOR_VIEW, f6 as AI_OTHERS_NODE_CREATOR_VIEW, aW as Transition, ih as useAssistantStore, dt as useCredentialsStore, cZ as useNodeTypesStore, jp as SlideTransition } from "./index-TQ22MZub.js";
import { f as formatTriggerActionName, u as useNodeCreatorStore, a as useViewStacks, c as camelCase, b as useKeyboardNavigation, t as transformNodeType, d as flattenCreateElements, T as TriggerView, R as RegularView, A as AIView, e as AINodesView } from "./NodeViewSwitcher-B6pXHQpy.js";
import { u as upperFirst } from "./RunDataAi-Dr6ypWYk.js";
import { u as useActions } from "./NodeCreation-CH8QZkmg.js";
import "./FileSaver.min-BZDLz63C.js";
import "./dateFormatter-BgjGibAI.js";
import "./useWorkflowActivate-DXNYJQNZ.js";
import "./pushConnection.store-DBI9rig9.js";
import "./useExecutionDebugging-rQ2a9vrr.js";
import "./useBeforeUnload-Db4Xtdlx.js";
...
const nodeCreator = "_nodeCreator_180z5_5";
const nodeCreatorScrim = "_nodeCreatorScrim_180z5_16";
const active = "_active_180z5_28";
const style0 = {
  nodeCreator,
  nodeCreatorScrim,
  active
