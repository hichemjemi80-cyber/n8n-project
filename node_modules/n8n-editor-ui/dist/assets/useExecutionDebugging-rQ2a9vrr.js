import { b as useRouter, a as useToast, T as useWorkflowsStore, m as useSettingsStore, K as useUIStore, p as computed, a8 as EnterpriseEditionFeature, bt as h, hd as sanitizeHtml, ae as MODAL_CONFIRM, V as VIEWS, Z as useRootStore, hn as isFullExecutionResponse, ho as DEBUG_PAYWALL_MODAL_KEY, ak as useTelemetry, g as useI18n, al as useMessage } from "./index-TQ22MZub.js";
const useExecutionDebugging = () => {
  ...
  const applyExecutionData = async (executionId) => {
    ...
    pinnableNodes.forEach((node) => {
      var _a2, _b;
      const nodeData = (_b = (_a2 = runData[node.name]) == null ? void 0 : _a2[0].data) == null ? void 0 : _b.main[0];
      if (nodeData) {
        pinnings++;
