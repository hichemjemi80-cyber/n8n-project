...
import { AccessDeniedException, ConflictException, FeaturedResultsConflictException, InternalServerException, InvalidRequestException, ResourceAlreadyExistException, ResourceInUseException, ResourceNotFoundException, ResourceUnavailableException, ServiceQuotaExceededException, ThrottlingException, ValidationException, } from "../models/errors";
import { KendraServiceException } from "../models/KendraServiceException";
var KmsKeyId = [0, n0, _KKI, 8, 0];
var NameType = [0, n0, _NT, 8, 0];
export var AccessControlConfigurationSummary$ = [3, n0, _ACCS,
    0,
    [_I],
    [0], 1
];
export var AccessControlListConfiguration$ = [3, n0, _ACLC,
    0,
    [_KP],
    [0]
];
...
export var AdditionalResultAttribute$ = [3, n0, _ARA,
    0,
    [_K, _VT, _V],
    [0, 0, () => AdditionalResultAttributeValue$], 3
];
export var AdditionalResultAttributeValue$ = [3, n0, _ARAV,
    0,
    [_TWHV],
    [() => TextWithHighlights$]
];
export var AlfrescoConfiguration$ = [3, n0, _ACl,
    0,
...
export var AssociateEntitiesToExperienceRequest$ = [3, n0, _AETER,
    0,
    [_I, _II, _EL],
    [0, 0, () => AssociateEntityList], 3
];
export var AssociateEntitiesToExperienceResponse$ = [3, n0, _AETERs,
    0,
    [_FEL],
    [() => AssociateEntitiesToExperienceFailedEntityList]
];
export var AssociatePersonasToEntitiesRequest$ = [3, n0, _APTER,
    0,
    [_I, _II, _P],
    [0, 0, () => EntityPersonaConfigurationList], 3
];
export var AssociatePersonasToEntitiesResponse$ = [3, n0, _APTERs,
    0,
    [_FEL],
    [() => FailedEntityList]
];
...
export var AttributeSuggestionsDescribeConfig$ = [3, n0, _ASDC,
    0,
    [_SCL, _ASM],
    [() => SuggestableConfigList, 0]
];
export var AttributeSuggestionsGetConfig$ = [3, n0, _ASGC,
    0,
    [_SAu, _ARAd, _AF, _UC],
    [64 | 0, 64 | 0, () => AttributeFilter$, () => UserContext$]
];
export var AttributeSuggestionsUpdateConfig$ = [3, n0, _ASUC,
    0,
    [_SCL, _ASM],
    [() => SuggestableConfigList, 0]
];
...
export var BasicAuthenticationConfiguration$ = [3, n0, _BAC,
    0,
    [_H, _Po, _C],
    [0, 1, 0], 3
];
...
export var BatchDeleteDocumentResponseFailedDocument$ = [3, n0, _BDDRFD,
    0,
    [_I, _DSI, _EC, _EM],
    [0, 0, 0, 0]
];
export var BatchDeleteFeaturedResultsSetError$ = [3, n0, _BDFRSE,
    0,
    [_I, _EC, _EM],
    [0, 0, 0], 3
];
export var BatchDeleteFeaturedResultsSetRequest$ = [3, n0, _BDFRSR,
    0,
    [_II, _FRSI],
    [0, 64 | 0], 2
];
export var BatchDeleteFeaturedResultsSetResponse$ = [3, n0, _BDFRSRa,
    0,
    [_E],
    [() => BatchDeleteFeaturedResultsSetErrors], 1
];
export var BatchGetDocumentStatusRequest$ = [3, n0, _BGDSR,
    0,
    [_II, _DILo],
    [0, () => DocumentInfoList], 2
];
export var BatchGetDocumentStatusResponse$ = [3, n0, _BGDSRa,
    0,
    [_E, _DSL],
    [() => BatchGetDocumentStatusResponseErrors, () => DocumentStatusList]
];
export var BatchGetDocumentStatusResponseError$ = [3, n0, _BGDSRE,
    0,
    [_DI, _DSI, _EC, _EM],
    [0, 0, 0, 0]
];
...
export var BatchPutDocumentResponseFailedDocument$ = [3, n0, _BPDRFD,
    0,
    [_I, _DSI, _EC, _EM],
    [0, 0, 0, 0]
];
export var BoxConfiguration$ = [3, n0, _BC,
    0,
...
export var ClearQuerySuggestionsRequest$ = [3, n0, _CQSR,
    0,
    [_II],
    [0], 1
];
export var ClickFeedback$ = [3, n0, _CF,
    0,
    [_RI, _CTl],
    [0, 4], 2
];
export var CollapseConfiguration$ = [3, n0, _CCo,
    0,
    [_DAK, _SC, _MAKS, _Ex, _ECx],
    [0, () => SortingConfigurationList, 0, 2, () => ExpandConfiguration$], 1
];
export var CollapsedResultDetail$ = [3, n0, _CRD,
    0,
    [_DA, _ER],
    [() => DocumentAttribute$, () => ExpandedResultList], 1
];
export var ColumnConfiguration$ = [3, n0, _CCol,
    0,
...
export var ConflictingItem$ = [3, n0, _CI,
    0,
    [_QT, _SN, _SIe],
    [0, 0, 0]
];
export var ConfluenceAttachmentConfiguration$ = [3, n0, _CAC,
    0,
    [_CAr, _AFM],
    [2, () => ConfluenceAttachmentFieldMappingsList]
];
export var ConfluenceAttachmentToIndexFieldMapping$ = [3, n0, _CATIFM,
    0,
    [_DSFN, _DFF, _IFN],
    [0, 0, 0]
];
export var ConfluenceBlogConfiguration$ = [3, n0, _CBC,
    0,
    [_BFM],
    [() => ConfluenceBlogFieldMappingsList]
];
export var ConfluenceBlogToIndexFieldMapping$ = [3, n0, _CBTIFM,
    0,
    [_DSFN, _DFF, _IFN],
    [0, 0, 0]
];
export var ConfluenceConfiguration$ = [3, n0, _CCon,
    0,
...
export var ConfluencePageConfiguration$ = [3, n0, _CPC,
    0,
    [_PFM],
    [() => ConfluencePageFieldMappingsList]
];
export var ConfluencePageToIndexFieldMapping$ = [3, n0, _CPTIFM,
    0,
    [_DSFN, _DFF, _IFN],
    [0, 0, 0]
];
export var ConfluenceSpaceConfiguration$ = [3, n0, _CSC,
    0,
    [_CPS, _CAS, _IS, _ES, _SFM],
    [2, 2, 64 | 0, 64 | 0, () => ConfluenceSpaceFieldMappingsList]
];
export var ConfluenceSpaceToIndexFieldMapping$ = [3, n0, _CSTIFM,
    0,
    [_DSFN, _DFF, _IFN],
    [0, 0, 0]
];
export var ConnectionConfiguration$ = [3, n0, _CConn,
    0,
    [_DH, _DP, _DN, _TN, _SA],
    [0, 1, 0, 0, 0], 5
];
export var ContentSourceConfiguration$ = [3, n0, _CSCo,
    0,
    [_DSIa, _FI, _DPC],
    [64 | 0, 64 | 0, 2]
];
export var Correction$ = [3, n0, _Co,
    0,
    [_BO, _EO, _T, _CTo],
    [1, 1, 0, 0]
];
export var CreateAccessControlConfigurationRequest$ = [3, n0, _CACCR,
    0,
    [_II, _N, _De, _ACL, _HACL, _CTli],
    [0, 0, 0, () => PrincipalList, () => HierarchicalPrincipalList, [0, 4]], 2
];
export var CreateAccessControlConfigurationResponse$ = [3, n0, _CACCRr,
    0,
    [_I],
    [0], 1
];
...
export var CreateExperienceRequest$ = [3, n0, _CER,
    0,
    [_N, _II, _RA, _Con, _De, _CTli],
    [0, 0, 0, () => ExperienceConfiguration$, 0, [0, 4]], 2
];
export var CreateExperienceResponse$ = [3, n0, _CERr,
    0,
    [_I],
    [0], 1
];
export var CreateFaqRequest$ = [3, n0, _CFR,
    0,
    [_II, _N, _SP, _RA, _De, _Ta, _FF, _CTli, _LC],
    [0, 0, () => S3Path$, 0, 0, () => TagList, 0, [0, 4], 0], 4
];
export var CreateFaqResponse$ = [3, n0, _CFRr,
    0,
    [_I],
    [0]
];
export var CreateFeaturedResultsSetRequest$ = [3, n0, _CFRSR,
    0,
    [_II, _FRSN, _De, _CTli, _St, _QTu, _FDe, _Ta],
    [0, 0, 0, 0, 0, 64 | 0, () => FeaturedDocumentList, () => TagList], 2
];
export var CreateFeaturedResultsSetResponse$ = [3, n0, _CFRSRr,
    0,
    [_FRS],
    [() => FeaturedResultsSet$]
];
...
export var CreateQuerySuggestionsBlockListRequest$ = [3, n0, _CQSBLR,
    0,
    [_II, _N, _SSP, _RA, _De, _CTli, _Ta],
    [0, 0, () => S3Path$, 0, 0, [0, 4], () => TagList], 4
];
export var CreateQuerySuggestionsBlockListResponse$ = [3, n0, _CQSBLRr,
    0,
    [_I],
    [0]
];
export var CreateThesaurusRequest$ = [3, n0, _CTR,
    0,
    [_II, _N, _RA, _SSP, _De, _Ta, _CTli],
    [0, 0, 0, () => S3Path$, 0, () => TagList, [0, 4]], 4
];
export var CreateThesaurusResponse$ = [3, n0, _CTRr,
    0,
    [_I],
    [0]
];
export var CustomDocumentEnrichmentConfiguration$ = [3, n0, _CDEC,
    0,
    [_IC, _PEHC, _PEHCo, _RA],
    [() => InlineCustomDocumentEnrichmentConfigurationList, () => HookConfiguration$, () => HookConfiguration$, 0]
];
export var DatabaseConfiguration$ = [3, n0, _DC,
    0,
...
export var DataSourceGroup$ = [3, n0, _DSG,
    0,
    [_GI, _DSI],
    [0, 0], 2
];
...
export var DataSourceSyncJobMetricTarget$ = [3, n0, _DSSJMT,
    0,
    [_DSI, _DSSJI],
    [0, 0], 1
];
export var DataSourceToIndexFieldMapping$ = [3, n0, _DSTIFM,
    0,
    [_DSFN, _IFN, _DFF],
    [0, 0, 0], 2
];
...
export var DeleteAccessControlConfigurationRequest$ = [3, n0, _DACCR,
    0,
    [_II, _I],
    [0, 0], 2
];
export var DeleteAccessControlConfigurationResponse$ = [3, n0, _DACCRe,
    0,
    [],
    []
];
...
export var DeleteExperienceRequest$ = [3, n0, _DER,
    0,
    [_I, _II],
    [0, 0], 2
];
export var DeleteExperienceResponse$ = [3, n0, _DERe,
    0,
    [],
    []
];
export var DeleteFaqRequest$ = [3, n0, _DFR,
    0,
    [_I, _II],
    [0, 0], 2
];
...
export var DeletePrincipalMappingRequest$ = [3, n0, _DPMR,
    0,
    [_II, _GI, _DSI, _OI],
    [0, 0, 0, 1], 2
];
export var DeleteQuerySuggestionsBlockListRequest$ = [3, n0, _DQSBLR,
    0,
    [_II, _I],
    [0, 0], 2
];
export var DeleteThesaurusRequest$ = [3, n0, _DTR,
    0,
    [_I, _II],
    [0, 0], 2
];
export var DescribeAccessControlConfigurationRequest$ = [3, n0, _DACCRes,
    0,
    [_II, _I],
    [0, 0], 2
];
export var DescribeAccessControlConfigurationResponse$ = [3, n0, _DACCResc,
    0,
    [_N, _De, _EM, _ACL, _HACL],
    [0, 0, 0, () => PrincipalList, () => HierarchicalPrincipalList], 1
];
export var DescribeDataSourceRequest$ = [3, n0, _DDSRe,
    0,
    [_I, _II],
    [0, 0], 2
];
export var DescribeDataSourceResponse$ = [3, n0, _DDSRes,
    0,
...
export var DescribeExperienceRequest$ = [3, n0, _DERes,
    0,
    [_I, _II],
    [0, 0], 2
];
export var DescribeExperienceResponse$ = [3, n0, _DEResc,
    0,
    [_I, _II, _N, _En, _Con, _CAre, _UA, _De, _St, _RA, _EM],
    [0, 0, 0, () => ExperienceEndpoints, () => ExperienceConfiguration$, 4, 4, 0, 0, 0, 0]
];
export var DescribeFaqRequest$ = [3, n0, _DFRe,
    0,
    [_I, _II],
    [0, 0], 2
];
export var DescribeFaqResponse$ = [3, n0, _DFRes,
    0,
    [_I, _II, _N, _De, _CAre, _UA, _SP, _St, _RA, _EM, _FF, _LC],
    [0, 0, 0, 0, 4, 4, () => S3Path$, 0, 0, 0, 0, 0]
];
export var DescribeFeaturedResultsSetRequest$ = [3, n0, _DFRSR,
    0,
    [_II, _FRSIe],
    [0, 0], 2
];
export var DescribeFeaturedResultsSetResponse$ = [3, n0, _DFRSRe,
    0,
...
export var DescribeIndexRequest$ = [3, n0, _DIRe,
    0,
    [_I],
    [0], 1
];
export var DescribeIndexResponse$ = [3, n0, _DIRes,
    0,
...
export var DescribePrincipalMappingRequest$ = [3, n0, _DPMRe,
    0,
    [_II, _GI, _DSI],
    [0, 0, 0], 2
];
export var DescribePrincipalMappingResponse$ = [3, n0, _DPMRes,
    0,
    [_II, _DSI, _GI, _GOIS],
    [0, 0, 0, () => GroupOrderingIdSummaries]
];
export var DescribeQuerySuggestionsBlockListRequest$ = [3, n0, _DQSBLRe,
    0,
    [_II, _I],
    [0, 0], 2
];
export var DescribeQuerySuggestionsBlockListResponse$ = [3, n0, _DQSBLRes,
    0,
    [_II, _I, _N, _De, _St, _EM, _CAre, _UA, _SSP, _ICt, _FSB, _RA],
    [0, 0, 0, 0, 0, 0, 4, 4, () => S3Path$, 1, 1, 0]
];
export var DescribeQuerySuggestionsConfigRequest$ = [3, n0, _DQSCR,
    0,
    [_II],
    [0], 1
];
export var DescribeQuerySuggestionsConfigResponse$ = [3, n0, _DQSCRe,
    0,
    [_Mo, _St, _QLLBWID, _IQWUI, _MNOQU, _MQC, _LSBT, _LCT, _TSC, _ASC],
    [0, 0, 1, 2, 1, 1, 4, 4, 1, () => AttributeSuggestionsDescribeConfig$]
];
export var DescribeThesaurusRequest$ = [3, n0, _DTRe,
    0,
    [_I, _II],
    [0, 0], 2
];
export var DescribeThesaurusResponse$ = [3, n0, _DTRes,
    0,
    [_I, _II, _N, _De, _St, _EM, _CAre, _UA, _RA, _SSP, _FSB, _TCe, _SRC],
    [0, 0, 0, 0, 0, 0, 4, 4, 0, () => S3Path$, 1, 1, 1]
];
export var DisassociateEntitiesFromExperienceRequest$ = [3, n0, _DEFER,
    0,
    [_I, _II, _EL],
    [0, 0, () => DisassociateEntityList], 3
];
export var DisassociateEntitiesFromExperienceResponse$ = [3, n0, _DEFERi,
    0,
    [_FEL],
    [() => FailedEntityList]
];
export var DisassociatePersonasFromEntitiesRequest$ = [3, n0, _DPFER,
    0,
    [_I, _II, _EIn],
    [0, 0, 64 | 0], 3
];
export var DisassociatePersonasFromEntitiesResponse$ = [3, n0, _DPFERi,
    0,
    [_FEL],
    [() => FailedEntityList]
];
...
export var DocumentAttribute$ = [3, n0, _DA,
    0,
    [_K, _V],
    [0, () => DocumentAttributeValue$], 2
];
export var DocumentAttributeCondition$ = [3, n0, _DAC,
    0,
    [_CDAK, _O, _COV],
...
export var DocumentAttributeValue$ = [3, n0, _DAV,
    0,
    [_SV, _SLV, _LV, _DV],
    [0, 64 | 0, 1, 4]
];
export var DocumentAttributeValueCountPair$ = [3, n0, _DAVCP,
    0,
    [_DAV, _Cou, _FR],
    [() => DocumentAttributeValue$, 1, () => FacetResultList]
];
export var DocumentInfo$ = [3, n0, _DIo,
    0,
    [_DI, _A],
    [0, () => DocumentAttributeList], 1
];
export var DocumentMetadataConfiguration$ = [3, n0, _DMCo,
    0,
    [_N, _Ty, _R, _Se],
    [0, 0, () => Relevance$, () => Search$], 2
];
export var DocumentRelevanceConfiguration$ = [3, n0, _DRC,
    0,
    [_N, _R],
    [0, () => Relevance$], 2
];
export var DocumentsMetadataConfiguration$ = [3, n0, _DMCoc,
    0,
    [_SPr],
    [0]
];
export var EntityConfiguration$ = [3, n0, _ECn,
    0,
    [_EInt, _ETnt],
    [0, 0], 2
];
export var EntityDisplayData$ = [3, n0, _EDD,
    0,
    [_UN, _GN, _IUN, _FN, _LN],
    [[() => NameType, 0], [() => NameType, 0], [() => NameType, 0], [() => NameType, 0], [() => NameType, 0]]
];
export var EntityPersonaConfiguration$ = [3, n0, _EPC,
    0,
    [_EInt, _Pe],
    [0, 0], 2
];
export var ExpandConfiguration$ = [3, n0, _ECx,
    0,
    [_MRITE, _MERPI],
    [1, 1]
];
export var ExpandedResultItem$ = [3, n0, _ERI,
    0,
    [_I, _DI, _DT, _DE, _DURI, _DAoc],
    [0, 0, () => TextWithHighlights$, () => TextWithHighlights$, 0, () => DocumentAttributeList]
];
export var ExperienceConfiguration$ = [3, n0, _ECxp,
    0,
    [_CSCo, _UIC],
    [() => ContentSourceConfiguration$, () => UserIdentityConfiguration$]
];
export var ExperienceEndpoint$ = [3, n0, _EE,
    0,
    [_ETnd, _End],
    [0, 0]
];
export var ExperienceEntitiesSummary$ = [3, n0, _EES,
    0,
    [_EInt, _ETnt, _DDi],
    [0, 0, [() => EntityDisplayData$, 0]]
];
export var ExperiencesSummary$ = [3, n0, _ESx,
    0,
    [_N, _I, _CAre, _St, _En],
    [0, 0, 4, 0, () => ExperienceEndpoints]
];
export var Facet$ = [3, n0, _F,
    0,
    [_DAK, _Fa, _MR],
    [0, () => FacetList, 1]
];
export var FacetResult$ = [3, n0, _FRa,
    0,
    [_DAK, _DAVT, _DAVCPo],
    [0, 0, () => DocumentAttributeValueCountPairList]
];
export var FailedEntity$ = [3, n0, _FE,
    0,
    [_EInt, _EM],
    [0, 0]
];
export var FaqStatistics$ = [3, n0, _FS,
    0,
    [_IQAC],
    [1], 1
];
export var FaqSummary$ = [3, n0, _FSa,
    0,
    [_I, _N, _St, _CAre, _UA, _FF, _LC],
    [0, 0, 0, 4, 4, 0, 0]
];
export var FeaturedDocument$ = [3, n0, _FDea,
    0,
    [_I],
    [0]
];
export var FeaturedDocumentMissing$ = [3, n0, _FDMe,
    0,
    [_I],
    [0]
];
export var FeaturedDocumentWithMetadata$ = [3, n0, _FDWMe,
    0,
    [_I, _Ti, _URI],
    [0, 0, 0]
];
export var FeaturedResultsConflictException$ = [-3, n0, _FRCE,
    { [_e]: _c, [_hE]: 409 },
    [_M, _CIo],
    [0, () => ConflictingItems]
];
TypeRegistry.for(n0).registerError(FeaturedResultsConflictException$, FeaturedResultsConflictException);
export var FeaturedResultsItem$ = [3, n0, _FRI,
    0,
...
export var FeaturedResultsSet$ = [3, n0, _FRS,
    0,
    [_FRSIe, _FRSN, _De, _St, _QTu, _FDe, _LUT, _CTr],
    [0, 0, 0, 0, 64 | 0, () => FeaturedDocumentList, 1, 1]
];
export var FeaturedResultsSetSummary$ = [3, n0, _FRSS,
    0,
    [_FRSIe, _FRSN, _St, _LUT, _CTr],
    [0, 0, 0, 1, 1]
];
export var FsxConfiguration$ = [3, n0, _FC,
    0,
    [_FSI, _FST, _VC, _SA, _IP, _EP, _FM],
    [0, 0, () => DataSourceVpcConfiguration$, 0, 64 | 0, 64 | 0, () => DataSourceToIndexFieldMappingList], 3
];
export var GetQuerySuggestionsRequest$ = [3, n0, _GQSR,
    0,
    [_II, _QT, _MSC, _STu, _ASC],
    [0, 0, 1, 64 | 0, () => AttributeSuggestionsGetConfig$], 2
];
export var GetQuerySuggestionsResponse$ = [3, n0, _GQSRe,
    0,
    [_QSI, _Su],
    [0, () => SuggestionList]
];
export var GetSnapshotsRequest$ = [3, n0, _GSR,
    0,
    [_II, _In, _MT, _NTe, _MR],
    [0, 0, 0, 0, 1], 3
];
export var GetSnapshotsResponse$ = [3, n0, _GSRe,
    0,
    [_SSTF, _SDH, _SD, _NTe],
...
export var GitHubDocumentCrawlProperties$ = [3, n0, _GHDCP,
    0,
    [_CRDr, _CIr, _CIC, _CICA, _CPR, _CPRC, _CPRCA],
    [2, 2, 2, 2, 2, 2, 2]
];
export var GoogleDriveConfiguration$ = [3, n0, _GDC,
    0,
...
export var GroupOrderingIdSummary$ = [3, n0, _GOISr,
    0,
...
export var HierarchicalPrincipal$ = [3, n0, _HP,
    0,
    [_PL],
    [() => PrincipalList], 1
];
export var Highlight$ = [3, n0, _Hi,
    0,
    [_BO, _EO, _TA, _Ty],
    [1, 1, 2, 0], 2
];
...
export var IndexConfigurationSummary$ = [3, n0, _ICS,
    0,
    [_CAre, _UA, _St, _N, _I, _Ed],
    [4, 4, 0, 0, 0, 0], 3
];
export var IndexStatistics$ = [3, n0, _ISn,
    0,
    [_FS, _TDS],
    [() => FaqStatistics$, () => TextDocumentStatistics$], 2
];
export var InlineCustomDocumentEnrichmentConfiguration$ = [3, n0, _ICDEC,
    0,
    [_Cond, _Tar, _DCD],
...
export var JsonTokenTypeConfiguration$ = [3, n0, _JTTC,
    0,
    [_UNAF, _GAF],
    [0, 0], 2
];
export var JwtTokenTypeConfiguration$ = [3, n0, _JTTCw,
    0,
    [_KL, _URL, _SMA, _UNAF, _GAF, _Is, _CR],
    [0, 0, 0, 0, 0, 0, 0], 1
];
export var ListAccessControlConfigurationsRequest$ = [3, n0, _LACCR,
    0,
    [_II, _NTe, _MR],
    [0, 0, 1], 1
];
export var ListAccessControlConfigurationsResponse$ = [3, n0, _LACCRi,
    0,
    [_ACC, _NTe],
...
export var ListEntityPersonasRequest$ = [3, n0, _LEPR,
    0,
    [_I, _II, _NTe, _MR],
    [0, 0, 0, 1], 2
];
export var ListEntityPersonasResponse$ = [3, n0, _LEPRi,
    0,
    [_SIum, _NTe],
    [() => PersonasSummaryList, 0]
];
export var ListExperienceEntitiesRequest$ = [3, n0, _LEER,
    0,
    [_I, _II, _NTe],
    [0, 0, 0], 2
];
export var ListExperienceEntitiesResponse$ = [3, n0, _LEERi,
    0,
    [_SIum, _NTe],
    [[() => ExperienceEntitiesSummaryList, 0], 0]
];
export var ListExperiencesRequest$ = [3, n0, _LER,
    0,
    [_II, _NTe, _MR],
    [0, 0, 1], 1
];
export var ListExperiencesResponse$ = [3, n0, _LERi,
    0,
    [_SIum, _NTe],
    [() => ExperiencesSummaryList, 0]
];
export var ListFaqsRequest$ = [3, n0, _LFR,
    0,
    [_II, _NTe, _MR],
    [0, 0, 1], 1
];
export var ListFaqsResponse$ = [3, n0, _LFRi,
    0,
    [_NTe, _FSIa],
    [0, () => FaqSummaryItems]
];
export var ListFeaturedResultsSetsRequest$ = [3, n0, _LFRSR,
    0,
    [_II, _NTe, _MR],
    [0, 0, 1], 1
];
export var ListFeaturedResultsSetsResponse$ = [3, n0, _LFRSRi,
    0,
    [_FRSSI, _NTe],
    [() => FeaturedResultsSetSummaryItems, 0]
];
export var ListGroupsOlderThanOrderingIdRequest$ = [3, n0, _LGOTOIR,
    0,
    [_II, _OI, _DSI, _NTe, _MR],
    [0, 1, 0, 0, 1], 2
];
export var ListGroupsOlderThanOrderingIdResponse$ = [3, n0, _LGOTOIRi,
    0,
    [_GSr, _NTe],
...
export var ListQuerySuggestionsBlockListsRequest$ = [3, n0, _LQSBLR,
    0,
    [_II, _NTe, _MR],
    [0, 0, 1], 1
];
export var ListQuerySuggestionsBlockListsResponse$ = [3, n0, _LQSBLRi,
    0,
    [_BLSI, _NTe],
...
export var ListThesauriRequest$ = [3, n0, _LTR,
    0,
    [_II, _NTe, _MR],
    [0, 0, 1], 1
];
export var ListThesauriResponse$ = [3, n0, _LTRi,
    0,
    [_NTe, _TSI],
    [0, () => ThesaurusSummaryItems]
];
export var MemberGroup$ = [3, n0, _MGe,
    0,
    [_GI, _DSI],
    [0, 0], 1
];
export var MemberUser$ = [3, n0, _MUe,
    0,
    [_UI],
    [0], 1
];
export var OneDriveConfiguration$ = [3, n0, _ODC,
    0,
    [_TD, _SA, _ODU, _IP, _EP, _FM, _DLG],
    [0, 0, () => OneDriveUsers$, 64 | 0, 64 | 0, () => DataSourceToIndexFieldMappingList, 2], 3
];
export var OneDriveUsers$ = [3, n0, _ODU,
    0,
    [_ODUL, _ODUSP],
    [64 | 0, () => S3Path$]
];
export var OnPremiseConfiguration$ = [3, n0, _OPC,
    0,
    [_HU, _ON, _SCSP],
    [0, 0, () => S3Path$], 3
];
export var PersonasSummary$ = [3, n0, _PS,
    0,
    [_EInt, _Pe, _CAre, _UA],
    [0, 0, 4, 4]
];
...
export var PutPrincipalMappingRequest$ = [3, n0, _PPMR,
    0,
...
export var QueryResult$ = [3, n0, _QRu,
    0,
...
export var QueryResultItem$ = [3, n0, _QRI,
    0,
...
export var QuerySuggestionsBlockListSummary$ = [3, n0, _QSBLS,
    0,
    [_I, _N, _St, _CAre, _UA, _ICt],
    [0, 0, 0, 4, 4, 1]
];
export var QuipConfiguration$ = [3, n0, _QC,
    0,
...
export var Relevance$ = [3, n0, _R,
    0,
    [_Fr, _Im, _Du, _RO, _VIM],
    [2, 1, 0, 0, 128 | 1]
];
export var RelevanceFeedback$ = [3, n0, _RFe,
    0,
    [_RI, _RV],
    [0, 0], 2
];
export var ResourceAlreadyExistException$ = [-3, n0, _RAEE,
    { [_e]: _c, [_hE]: 400 },
    [_M],
    [0]
];
...
export var S3Path$ = [3, n0, _SP,
    0,
    [_Bu, _K],
    [0, 0], 2
];
export var SaaSConfiguration$ = [3, n0, _SSC,
    0,
    [_ON, _HU],
    [0, 0], 2
];
export var SalesforceChatterFeedConfiguration$ = [3, n0, _SCFC,
    0,
    [_DDFN, _DTFN, _FM, _IFT],
    [0, 0, () => DataSourceToIndexFieldMappingList, 64 | 0], 1
];
export var SalesforceConfiguration$ = [3, n0, _SCa,
    0,
...
export var SalesforceCustomKnowledgeArticleTypeConfiguration$ = [3, n0, _SCKATC,
    0,
    [_N, _DDFN, _DTFN, _FM],
    [0, 0, 0, () => DataSourceToIndexFieldMappingList], 2
];
export var SalesforceKnowledgeArticleConfiguration$ = [3, n0, _SKAC,
    0,
    [_ISnc, _SKATC, _CKATC],
    [64 | 0, () => SalesforceStandardKnowledgeArticleTypeConfiguration$, () => SalesforceCustomKnowledgeArticleTypeConfigurationList], 1
];
export var SalesforceStandardKnowledgeArticleTypeConfiguration$ = [3, n0, _SSKATC,
    0,
    [_DDFN, _DTFN, _FM],
    [0, 0, () => DataSourceToIndexFieldMappingList], 1
];
export var SalesforceStandardObjectAttachmentConfiguration$ = [3, n0, _SSOAC,
    0,
    [_DTFN, _FM],
    [0, () => DataSourceToIndexFieldMappingList]
];
export var SalesforceStandardObjectConfiguration$ = [3, n0, _SSOC,
    0,
    [_N, _DDFN, _DTFN, _FM],
    [0, 0, 0, () => DataSourceToIndexFieldMappingList], 2
];
export var ScoreAttributes$ = [3, n0, _SAc,
    0,
    [_SCc],
    [0]
];
export var Search$ = [3, n0, _Se,
    0,
    [_Fac, _Sea, _Di, _So],
    [2, 2, 2, 2]
];
export var SeedUrlConfiguration$ = [3, n0, _SUC,
    0,
    [_SUee, _WCM],
    [64 | 0, 0], 1
];
...
export var ServiceNowKnowledgeArticleConfiguration$ = [3, n0, _SNKAC,
    0,
    [_DDFN, _CAr, _IAFP, _EAFP, _DTFN, _FM, _FQ],
    [0, 2, 64 | 0, 64 | 0, 0, () => DataSourceToIndexFieldMappingList, 0], 1
];
export var ServiceNowServiceCatalogConfiguration$ = [3, n0, _SNSCC,
    0,
...
export var SharePointConfiguration$ = [3, n0, _SPC,
    0,
...
export var SiteMapsConfiguration$ = [3, n0, _SMC,
    0,
    [_SM],
    [64 | 0], 1
];
...
export var SortingConfiguration$ = [3, n0, _SCor,
    0,
    [_DAK, _SO],
    [0, 0], 2
];
export var SourceDocument$ = [3, n0, _SDo,
    0,
    [_DI, _SAu, _AA],
    [0, 64 | 0, () => DocumentAttributeList]
];
export var SpellCorrectedQuery$ = [3, n0, _SCQp,
    0,
    [_SQT, _Cor],
    [0, () => CorrectionList]
];
export var SpellCorrectionConfiguration$ = [3, n0, _SCC,
    0,
    [_IQSCS],
    [2], 1
];
export var SqlConfiguration$ = [3, n0, _SCq,
    0,
    [_QIEO],
    [0]
];
...
export var SuggestableConfig$ = [3, n0, _SCu,
    0,
    [_AN, _Sug],
    [0, 2]
];
export var Suggestion$ = [3, n0, _Sugg,
    0,
    [_I, _V, _SDou],
    [0, () => SuggestionValue$, () => SourceDocuments]
];
export var SuggestionHighlight$ = [3, n0, _SH,
    0,
    [_BO, _EO],
    [1, 1]
];
export var SuggestionTextWithHighlights$ = [3, n0, _STWH,
    0,
    [_Te, _Hig],
    [0, () => SuggestionHighlightList]
];
export var SuggestionValue$ = [3, n0, _SVu,
    0,
    [_Te],
    [() => SuggestionTextWithHighlights$]
];
export var TableCell$ = [3, n0, _TCa,
    0,
    [_V, _TA, _High, _He],
    [0, 2, 2, 2]
];
export var TableExcerpt$ = [3, n0, _TE,
    0,
    [_Ro, _TNORo],
    [() => TableRowList, 1]
];
export var TableRow$ = [3, n0, _TR,
    0,
    [_Ce],
    [() => TableCellList]
];
...
export var TemplateConfiguration$ = [3, n0, _TC,
    0,
    [_Tem],
    [15]
];
...
export var TextWithHighlights$ = [3, n0, _TWH,
    0,
    [_Te, _Hig],
    [0, () => HighlightList]
];
export var ThesaurusSummary$ = [3, n0, _TS,
    0,
    [_I, _N, _St, _CAre, _UA],
    [0, 0, 0, 4, 4]
];
...
export var TimeRange$ = [3, n0, _TRi,
    0,
    [_ST, _ETn],
    [4, 4]
];
...
export var UpdateAccessControlConfigurationRequest$ = [3, n0, _UACCR,
    0,
    [_II, _I, _N, _De, _ACL, _HACL],
    [0, 0, 0, 0, () => PrincipalList, () => HierarchicalPrincipalList], 2
];
export var UpdateAccessControlConfigurationResponse$ = [3, n0, _UACCRp,
    0,
    [],
    []
];
...
export var UpdateExperienceRequest$ = [3, n0, _UER,
    0,
    [_I, _II, _N, _RA, _Con, _De],
    [0, 0, 0, 0, () => ExperienceConfiguration$, 0], 2
];
export var UpdateFeaturedResultsSetRequest$ = [3, n0, _UFRSR,
    0,
    [_II, _FRSIe, _FRSN, _De, _St, _QTu, _FDe],
    [0, 0, 0, 0, 0, 64 | 0, () => FeaturedDocumentList], 2
];
export var UpdateFeaturedResultsSetResponse$ = [3, n0, _UFRSRp,
    0,
    [_FRS],
    [() => FeaturedResultsSet$]
];
...
export var UpdateQuerySuggestionsBlockListRequest$ = [3, n0, _UQSBLR,
    0,
    [_II, _I, _N, _De, _SSP, _RA],
    [0, 0, 0, 0, () => S3Path$, 0], 2
];
export var UpdateQuerySuggestionsConfigRequest$ = [3, n0, _UQSCR,
    0,
    [_II, _Mo, _QLLBWID, _IQWUI, _MNOQU, _MQC, _ASC],
    [0, 0, 1, 2, 1, 1, () => AttributeSuggestionsUpdateConfig$], 1
];
export var UpdateThesaurusRequest$ = [3, n0, _UTR,
    0,
    [_I, _II, _N, _De, _RA, _SSP],
    [0, 0, 0, 0, 0, () => S3Path$], 2
];
export var Urls$ = [3, n0, _U,
    0,
    [_SUC, _SMC],
...
export var UserGroupResolutionConfiguration$ = [3, n0, _UGRC,
    0,
    [_UGRM],
    [0], 1
];
export var UserIdentityConfiguration$ = [3, n0, _UIC,
    0,
    [_IAN],
    [0]
];
export var UserTokenConfiguration$ = [3, n0, _UTCs,
    0,
    [_JTTCw, _JTTC],
...
export var WorkDocsConfiguration$ = [3, n0, _WDC,
    0,
...
export var AssociateEntitiesToExperience$ = [9, n0, _AETE,
    0, () => AssociateEntitiesToExperienceRequest$, () => AssociateEntitiesToExperienceResponse$
];
export var AssociatePersonasToEntities$ = [9, n0, _APTE,
...
export var BatchDeleteFeaturedResultsSet$ = [9, n0, _BDFRS,
    0, () => BatchDeleteFeaturedResultsSetRequest$, () => BatchDeleteFeaturedResultsSetResponse$
];
export var BatchGetDocumentStatus$ = [9, n0, _BGDS,
...
export var ClearQuerySuggestions$ = [9, n0, _CQS,
    0, () => ClearQuerySuggestionsRequest$, () => __Unit
];
export var CreateAccessControlConfiguration$ = [9, n0, _CACC,
...
export var SubmitFeedback$ = [9, n0, _SFu,
...
export var UpdateAccessControlConfiguration$ = [9, n0, _UACC,
...
export var UpdateExperience$ = [9, n0, _UE,
    0, () => UpdateExperienceRequest$, () => __Unit
];
export var UpdateFeaturedResultsSet$ = [9, n0, _UFRS,
...
export var UpdateQuerySuggestionsBlockList$ = [9, n0, _UQSBL,
    0, () => UpdateQuerySuggestionsBlockListRequest$, () => __Unit
];
export var UpdateQuerySuggestionsConfig$ = [9, n0, _UQSC,
    0, () => UpdateQuerySuggestionsConfigRequest$, () => __Unit
];
export var UpdateThesaurus$ = [9, n0, _UT,
