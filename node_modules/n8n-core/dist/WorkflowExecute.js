...
const cleanRunData_1 = require("./PartialExecutionUtils/cleanRunData");
const recreateNodeExecutionStack_1 = require("./PartialExecutionUtils/recreateNodeExecutionStack");
class WorkflowExecute {
    ...
    runPartialWorkflow2(workflow, runData, destinationNodeName, pinData) {
        ...
        const startNodes = (0, PartialExecutionUtils_1.findStartNodes)({ graph: subgraph, trigger, destination, runData });
        const cycles = (0, PartialExecutionUtils_1.findCycles)(workflow);
        if (cycles.length) {
        }
        const newRunData = (0, cleanRunData_1.cleanRunData)(runData, graph, startNodes);
        const { nodeExecutionStack, waitingExecution, waitingExecutionSource } = (0, recreateNodeExecutionStack_1.recreateNodeExecutionStack)(subgraph, startNodes, destination, runData, pinData ?? {});
        this.status = 'running';
        this.runExecutionData = {
            startData: {
