...
let FrontendService = class FrontendService {
    constructor(globalConfig, logger, loadNodesAndCredentials, credentialTypes, credentialsOverwrites, license, mailer, instanceSettings, urlService) {
    ...
    initSettings() {
        ...
        this.settings = {
            ...
            license: {
                consumerId: 'unknown',
                environment: config_2.default.getEnv('license.tenantId') === 1 ? 'production' : 'staging',
            },
            variables: {
                limit: 0,
            },
            ...
            pruning: {
                isEnabled: config_2.default.getEnv('executions.pruneData'),
                maxAge: config_2.default.getEnv('executions.pruneDataMaxAge'),
                maxCount: config_2.default.getEnv('executions.pruneDataMaxCount'),
            },
            security: {
                blockFileAccessToN8nFiles: config_2.default.getEnv('security.blockFileAccessToN8nFiles'),
            },
        };
    }
    async generateTypes() {
