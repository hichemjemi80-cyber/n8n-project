...
let PruningService = class PruningService {
    ...
    isPruningEnabled() {
        ...
        if (!config_1.default.getEnv('executions.pruneData') || constants_1.inTest || instanceType !== 'main') {
            return false;
        }
        if (config_1.default.getEnv('multiMainSetup.enabled') && instanceType === 'main' && isFollower) {
            return false;
        }
        return true;
    }
