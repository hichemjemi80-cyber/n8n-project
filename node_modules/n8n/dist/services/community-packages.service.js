...
let CommunityPackagesService = class CommunityPackagesService {
    constructor(instanceSettings, logger, installedPackageRepository, loadNodesAndCredentials, orchestrationService, license, globalConfig) {
    ...
    async installOrUpdatePackage(packageName, options) {
        ...
        if (loader.loadedNodes.length > 0) {
            try {
                ...
                await this.orchestrationService.publish(isUpdate ? 'community-package-update' : 'community-package-install', { packageName, packageVersion });
                await this.loadNodesAndCredentials.postProcessLoaders();
