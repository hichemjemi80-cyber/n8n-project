...
const multi_main_setup_ee_1 = require("./orchestration/main/multi-main-setup.ee");
let OrchestrationService = class OrchestrationService {
    constructor(logger, instanceSettings, multiMainSetup) {
        this.logger = logger;
    ...
    async publish(commandKey, payload) {
        if (!this.sanityCheck())
            return;
        this.logger.debug(`[Instance ID ${this.instanceSettings.hostId}] Publishing command "${commandKey}"`, payload);
