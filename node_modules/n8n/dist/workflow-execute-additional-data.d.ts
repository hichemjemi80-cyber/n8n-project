...
import type { IDataObject, IExecuteWorkflowInfo, INodeExecutionData, INodeParameters, IRun, IWorkflowBase, IWorkflowExecuteAdditionalData, IWorkflowExecuteHooks, IWorkflowHooksOptionalParameters, IWorkflowSettings, WorkflowExecuteMode, ExecutionStatus, ExecuteWorkflowOptions, IWorkflowExecutionDataProcess } from 'n8n-workflow';
import type { IWorkflowExecuteProcess } from './interfaces';
...
export declare function executeWorkflow(workflowInfo: IExecuteWorkflowInfo, additionalData: IWorkflowExecuteAdditionalData, options: ExecuteWorkflowOptions): Promise<Array<INodeExecutionData[] | null> | IWorkflowExecuteProcess>;
