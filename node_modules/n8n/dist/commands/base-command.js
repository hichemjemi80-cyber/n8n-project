...
class BaseCommand extends core_1.Command {
    constructor() {
        ...
        this.gracefulShutdownTimeoutInS = config_2.default.getEnv('generic.gracefulShutdownTimeout');
    ...
    async initLicense() {
        ...
        const activationKey = config_2.default.getEnv('license.activationKey');
        if (activationKey) {
