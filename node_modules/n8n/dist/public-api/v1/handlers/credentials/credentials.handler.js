...
module.exports = {
    ...
    transferCredential: [
        ...
        async (req, res) => {
            ...
            await typedi_1.Container.get(credentials_service_ee_1.EnterpriseCredentialsService).transferOne(req.user, req.params.workflowId, body.destinationProjectId);
            res.status(204).send();
        },
    ],
    deleteCredential: [
