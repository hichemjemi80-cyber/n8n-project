...
export declare class License {
    ...
    constructor(logger: Logger, instanceSettings: InstanceSettings, orchestrationService: OrchestrationService, settingsRepository: SettingsRepository, licenseMetricsService: LicenseMetricsService);
