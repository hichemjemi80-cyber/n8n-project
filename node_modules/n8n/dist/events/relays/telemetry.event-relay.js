...
let TelemetryEventRelay = class TelemetryEventRelay extends event_relay_1.EventRelay {
    ...
    licenseCommunityPlusRegistered({ email, licenseKey, }) {
    ...
    async serverStarted() {
        ...
        const info = {
            ...
            execution_variables: {
                ...
                executions_data_prune: config_2.default.getEnv('executions.pruneData'),
                executions_data_max_age: config_2.default.getEnv('executions.pruneDataMaxAge'),
            },
            ...
            license_tenant_id: config_2.default.getEnv('license.tenantId'),
            binary_data_s3: isS3Available && isS3Selected && isS3Licensed,
            multi_main_setup_enabled: config_2.default.getEnv('multiMainSetup.enabled'),
            metrics: {
