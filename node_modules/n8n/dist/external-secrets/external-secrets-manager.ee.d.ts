...
export declare class ExternalSecretsManager {
    ...
    constructor(logger: Logger, settingsRepo: SettingsRepository, license: License, secretsProviders: ExternalSecretsProviders, cipher: Cipher, eventService: EventService);
    init(): Promise<void>;
    shutdown(): void;
