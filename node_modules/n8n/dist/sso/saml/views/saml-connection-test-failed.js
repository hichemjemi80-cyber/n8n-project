...
exports.getSamlConnectionTestFailedView = getSamlConnectionTestFailedView;
function getSamlConnectionTestFailedView(message, attributes) {
    return `
    <http>
    <head>
...
//# sourceMappingURL=saml-connection-test-failed.js.map