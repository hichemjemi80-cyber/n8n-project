...
const saml_connection_test_failed_1 = require("../views/saml-connection-test-failed");
const saml_connection_test_success_1 = require("../views/saml-connection-test-success");
        ...
        try {
            ...
            if ((0, saml_helpers_1.isConnectionTestRequest)(req)) {
                if (loginResult.authenticatedUser) {
                    return res.send((0, saml_connection_test_success_1.getSamlConnectionTestSuccessView)(loginResult.attributes));
                }
                else {
                    return res.send((0, saml_connection_test_failed_1.getSamlConnectionTestFailedView)('', loginResult.attributes));
                }
            }
            if (loginResult.authenticatedUser) {
            ...
            if ((0, saml_helpers_1.isConnectionTestRequest)(req)) {
                return res.send((0, saml_connection_test_failed_1.getSamlConnectionTestFailedView)(error.message));
            }
            this.eventService.emit('user-login-failed', {
                userEmail: 'unknown',
                authenticationMethod: 'saml',
...
__decorate([
    (0, decorators_1.Get)('/acs', { middlewares: [saml_enabled_middleware_1.samlLicensedMiddleware], skipAuth: true }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], SamlController.prototype, "acsGet", null);
__decorate([
    (0, decorators_1.Post)('/acs', { middlewares: [saml_enabled_middleware_1.samlLicensedMiddleware], skipAuth: true }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
